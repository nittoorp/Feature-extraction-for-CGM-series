...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 15:35:46 2020
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  7 13:20:18 2020
...
for i in range(len(dataset_nomeal)):
    ...
    #adding all feature to one feature matrix to use it for PCA calculation
    features_vector = slope + overall_max_power_sdensity_nomeal + row_coefficient + row_window 
...
cross_validation_dt = cross_val_score(dt, X_train, y_train, cv=10)
print("Accuracy: %0.2f (+/- %0.2f)" % (cross_validation_dt.mean(), cross_validation_dt.std() * 2))
...
accuracy_svm =[]
classifier_SVM_cv = SVC(kernel = 'rbf')
...
from sklearn.metrics import confusion_matrix
cm_decisiontree = confusion_matrix(y_test, y_pred_NN)
