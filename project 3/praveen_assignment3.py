...
data1 = dataproc.getColLength('mealData1.csv')
data2 = dataproc.getColLength('mealData2.csv')
data3 = dataproc.getColLength('mealData3.csv')
data4 = dataproc.getColLength('mealData4.csv')
data5 = dataproc.getColLength('mealData5.csv')
...
data1 = data1.iloc[0:50, 0:30]
data2 = data2.iloc[0:50, 0:30]
data3 = data3.iloc[0:50, 0:30]
data4 = data4.iloc[0:50, 0:30]
data5 = data5.iloc[0:50, 0:30]

#combining data from all dataset after cleaning
combinedData = pd.concat([data1, data2, data3, data4, data5])

labels = dataproc.getLabels()
overall_slopes = []
